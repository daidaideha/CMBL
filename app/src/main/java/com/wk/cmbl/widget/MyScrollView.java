...
//            this.mOnScrollListener.onScroll(l, t, oldl, oldt);
//        }
...
//    }
    ...
    class ScalingRunnalable implements Runnable {
        ...
        public void run() {
            ...
            if ((!this.mIsFinished) && (this.mScale > 1.0D)) {
                ...
                f2 = this.mScale - (this.mScale - 1.0F)
                        * MyScrollView.sInterpolator.getInterpolation(f1);
                localLayoutParams = MyScrollView.this.mHeaderContainer
                        .getLayoutParams();
                if (f2 > 1.0F) {
                    Log.d("mmm", "f2>1.0");
                    localLayoutParams.height = MyScrollView.this.mHeaderHeight;
                    localLayoutParams.height = ((int) (f2 * MyScrollView.this.mHeaderHeight));
                    MyScrollView.this.mHeaderContainer
                            .setLayoutParams(localLayoutParams);
        ...
        public void startAnimation(long paramLong) {
            ...
            this.mScale = ((float) (MyScrollView.this.mHeaderContainer
                    .getBottom()) / MyScrollView.this.mHeaderHeight);
