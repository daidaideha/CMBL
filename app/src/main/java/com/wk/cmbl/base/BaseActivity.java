...
//		}
    ...
    /***
     * 隐藏头部bar
     * @param hide true为隐藏，false为显示
     */
	public void setHeaderBarHide(boolean hide) {
        if (hide)
		    findViewById(R.id.header_style_title).setVisibility(View.GONE);
        else
            findViewById(R.id.header_style_title).setVisibility(View.VISIBLE);
	}
